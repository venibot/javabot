...
public class GuildMemberLeave extends ListenerAdapter {
    ...
    public void onGuildMemberRemove(GuildMemberRemoveEvent removeEvent) {
        ...
        if (logChannel != null) {
            ...
            logEmbed.addField("Аккаунт создан", DataFormatter.datetimeToString(removeEvent.getUser()
                    .getTimeCreated()));

            logEmbed.addField("Был на сервере с", DataFormatter.datetimeToString(removeEvent.getMember()
                    .getTimeJoined()));
