...
public class Bug {
    ...
    public Bug(Integer bugID, Long userID, Long guildID, String text, Long privateMessage) {
        this.bugID = bugID;
        this.userID = userID;
    ...
    public Bug(Integer bugID, Long userID, Long guildID, String text, String status, Long sendTime, Long acceptTime, Long disagreeTime, Long didTime, Long privateMessage, Long publicMessage) {
        this.bugID = bugID;
        this.userID = userID;
        this.guildID = guildID;
        this.text = text;
    ...
    public static Bug fromDBObject(DBObject document) {
        Bug idea = new Bug(
                (Integer) document.get("bugID"),
    ...
    public String toString() {
        return "Баг от " + this.userID + ", сервер " + this.guildID + ". Статус " + this.status + ". " + this.text;
    }
}
