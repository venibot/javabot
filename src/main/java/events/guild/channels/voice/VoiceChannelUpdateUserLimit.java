    ...
    public void onVoiceChannelUpdateUserLimit(VoiceChannelUpdateUserLimitEvent updateUserLimitEvent) {
        ...
        if (logChannel != null) {
            ...
            logEmbed.addField("Старый лимит",
                    (updateUserLimitEvent.getOldUserLimit() != 0 ? updateUserLimitEvent.getOldUserLimit() : "Бесконечное кол-во")
                                + " участников");
            logEmbed.addField("Новый лимит",
                    (updateUserLimitEvent.getNewUserLimit() != 0 ? updateUserLimitEvent.getNewUserLimit() : "Бесконечное кол-во")
                            + " участников");
